...
#include <fstream>
#include <ip.hpp>
#include <max_closure2_ip.hpp>
#define STOPPING_TIME 7200
using namespace std;
using namespace ip;
using namespace mcip2;
/* cut_callback */
int __stdcall mcip2::cut_callback(GRBmodel *model, void *cbdata, int where, void *usrdata){
...
/* zero_forcing */
int mcip2::zero_forcing(ip::graph &our_graph)
{
    GRBenv *env = NULL;
